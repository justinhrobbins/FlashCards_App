...
public class EditFlashCardViewImplDesktop extends AbstractFlashCardsAppForm implements EditFlashCardView {

	private static FlashCardFormUiBinder uiBinder = GWT.create(FlashCardFormUiBinder.class);
	interface FlashCardFormUiBinder extends UiBinder<Widget, EditFlashCardViewImplDesktop> {}
