...
public class ConstsUtil {
	...
	public static final String LOG_IN_URL = "/flashcardsapi/login/loginForm.jsp";
	public static final String OPEN_ID_URL = "/flashcardsapi/login/openIdServlet";
	public static final String SHELL_VIEW = "ShellView";
	public static final String TAG_FORM = "tagForm";
	public static final String USER_ID = "userId";
	public static final String FLASHCARD_REST_URL = "/flashcardsapi/v1/flashcards";
