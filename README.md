...
1. The [Google Web Toolkit client version](www.socialflashcards.com/flashcardsgwt/) is a rich JavaScript/AJAX client that interacts with the server through a stateless REST API.
