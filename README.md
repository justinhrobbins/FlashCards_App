...
### Service
* Spring
    - [Spring Data - JPA](http://www.springsource.org/spring-data/jpa) If you are not familiear with Spring Data, you might like to take a look at the [Spring Data Example Showcase](https://github.com/SpringSource/spring-data-jpa-examples/tree/master/spring-data-jpa-showcase) on Github.  The project compares a a typical data access implementation with JPA 2 with a less boilerplate Spring Data version.  Spring Data was formerly known as [Hades](https://github.com/synyx/hades)
    - Transactions
