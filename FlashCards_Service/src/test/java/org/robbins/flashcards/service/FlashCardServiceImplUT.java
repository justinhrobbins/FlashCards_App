...
public class FlashCardServiceImplUT extends BaseMockingTest {
    ...
    public void testFindByQuestion() {
        when(repository.findByQuestion(Matchers.anyString())).thenReturn(
    ...
    public void testFindByQuestionLike() {
        when(repository.findByQuestionLike(Matchers.anyString())).thenReturn(
    ...
    public void testFindByTagsIn() {
        when(repository.findByTagsIn(new HashSet<Tag>())).thenReturn(
                new ArrayList<FlashCard>());
    ...
    public void testFindByQuestionLikeWithPageRequest() {
        when(repository.findByQuestionLike("Question", mock(PageRequest.class))).thenReturn(
                new ArrayList<FlashCard>());
