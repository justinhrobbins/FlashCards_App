...
public abstract class AbstractRestTestClient<E> extends BaseRestTest {
	...
	public E[] getEntityList(String url, Class<E[]> clazz) {
		...
		ResponseEntity<E[]> response = getRestTemplate().exchange(url,
	...
	public E getEntity(String url, Long id, Class<E> clazz) {
		...
		// include the Authentication header
		ResponseEntity<E> response = getRestTemplate().exchange(url,
				HttpMethod.GET, httpEntity, clazz, vars);
	...
	public E searchSingleEntity(String url, Map<String, String> uriVariables,
		...
		// include the Authentication header
		ResponseEntity<E> response = getRestTemplate().exchange(url,
				HttpMethod.GET, httpEntity, clazz, uriVariables);
	...
	public Long searchCount(String url, Map<String, String> uriVariables) {
		...
		// include the Authentication header
		ResponseEntity<Long> response = getRestTemplate().exchange(url,
				HttpMethod.GET, httpEntity, Long.class, uriVariables);
	...
	public HttpStatus putEntity(String url, Long id, E entity) {
		...
		ResponseEntity response = getRestTemplate().exchange(url,
				HttpMethod.PUT, httpEntity, null, vars);
	...
	public HttpStatus updateEntity(String url,
		...
		@SuppressWarnings("rawtypes")
		ResponseEntity response = getRestTemplate().exchange(url,
				HttpMethod.POST, httpEntity, null, uriVariables);
		return response.getStatusCode();
	}
	...
	public HttpStatus putEntity(String url, Map<String, String> uriVariables,
		...
		@SuppressWarnings("rawtypes")
		ResponseEntity response = getRestTemplate().exchange(url,
				HttpMethod.PUT, httpEntity, null, uriVariables);
		return response.getStatusCode();
	}
	...
	public HttpStatus deleteEntity(String url, Long id) {
		...
		@SuppressWarnings("rawtypes")
		ResponseEntity response = getRestTemplate().exchange(url,
				HttpMethod.DELETE, httpEntity, null, vars);
		return response.getStatusCode();
	}
}
