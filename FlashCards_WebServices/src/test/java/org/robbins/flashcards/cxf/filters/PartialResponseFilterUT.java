...
public class PartialResponseFilterUT extends BaseMockingTest {
	...
	public void before() {
		...
		ReflectionTestUtils.setField(partialResponseFilter, "fieldInitializer", mockFieldInitializer);
		ReflectionTestUtils.setField(partialResponseFilter, "objectMapper", mockObjectMapper);
	...
	public void responseSatusNotOk() {
		...
		Response response = partialResponseFilter.handleResponse(null, mockOri, mockResponse);
		assertThat(response, is(nullValue()));
	}
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Test
	public void defaultParameter() throws JsonGenerationException, JsonMappingException, IOException {
		OperationResourceInfo mockOri = mock(OperationResourceInfo.class);

		String entity = new String("my_entity");
		ResponseBuilder builder = new ResponseBuilderImpl();
		Response response = builder.status(Response.Status.OK.getStatusCode()).entity(entity).build();
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Test
	public void defaultParameterCollection() throws JsonGenerationException, JsonMappingException, IOException {
		OperationResourceInfo mockOri = mock(OperationResourceInfo.class);
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Test
	public void defaultParameterArray() throws JsonGenerationException, JsonMappingException, IOException {
		OperationResourceInfo mockOri = mock(OperationResourceInfo.class);
