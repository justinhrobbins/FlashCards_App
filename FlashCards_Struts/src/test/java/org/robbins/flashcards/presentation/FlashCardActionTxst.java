...
public class FlashCardActionTxst extends StrutsTestCase {
	...
	public void testCreateFlashCardFailOnQuestion() throws Exception {
        ...
        assertTrue("Problem There were no errors present in fieldErrors but there should have been one error present", flashCardAction.getFieldErrors().size() == 1);
		assertTrue("Problem field 'question' not present in fieldErrors but it should have been",
    ...
    public void testCreateFlashCard() throws Exception {
        ...
        assertTrue("Problem There were errors present in fieldErrors but there should not have been any errors present", flashCardAction.getFieldErrors().size() == 0);
